 ...
 * @author mai
 */
public class ReportPlayersDetailDialog extends ApplicationDialog {

    private ReportPlayersDetailPanel panel;

    public ReportPlayersDetailDialog() {
...
//        bpanel.add(btClose);
    ...
    protected JComponent createDialogContentPane() {
        ...
        width = width - (int) (width * 0.47);
        System.out.println("--->>>>" + height + ", " + width);
        Dimension dimension = new Dimension(width, height);
        if (panel == null) {
            panel = new ReportPlayersDetailPanel();
        }
