...
public class PlayersGraphModel {
    ...
    public String getPlayerNameNumber() {
        return playerNameNumber;
    }

    public void setPlayerNameNumber(String playerNameNumber) {
        this.playerNameNumber = playerNameNumber;
    }
    ...
    public String getContractStartEnd() {
        return contractStartEnd;
    }

    public void setContractStartEnd(String contractStartEnd) {
