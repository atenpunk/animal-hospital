...
public class ProcessSearchCustomerProfileDialog extends javax.swing.JDialog implements Runnable {
    ...
    public ProcessSearchCustomerProfileDialog(java.awt.Frame parent, boolean modal, Runnable r, String msg) {
        super(parent, modal);
...
//        String build = Application.instance().getDescriptor().getVersion() + " ( " + Application.instance().getDescriptor().getBuildId() + " )";
        jLabel3.setText("POS  Search Account from Central System ");
//        jLabel1.setText(msg);
