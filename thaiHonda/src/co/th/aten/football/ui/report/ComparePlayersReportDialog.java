 ...
 * @author Atenpunk
 */
public class ComparePlayersReportDialog extends ApplicationDialog {

//    private PosStockModel filter;
    private List<PlayersModel> playersModelList;
    private Image imageRadar;

    public ComparePlayersReportDialog(List<PlayersModel> playersModelList,Image imageRadar) {
//        this.filter = filter;
    ...
    protected JComponent createDialogContentPane() {
        ...
        setResizable(true);
        ComparePlayersReport print = new ComparePlayersReport(playersModelList,imageRadar);
