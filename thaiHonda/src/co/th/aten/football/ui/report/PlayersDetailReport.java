 ...
 * @author Atenpunk
 */
public class PlayersDetailReport extends AbstractReport {

    private JRViewer jrViewer;
    private String fileName = "reports/ReportTable.jasper";
    private List<PlayersModel> modelList;

    public PlayersDetailReport(List<PlayersModel> modelList) {
