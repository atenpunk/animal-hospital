...
public class TouupMonthReport extends AbstractReport {
	...
	private final String fileName = "/reports/TopupReportByMonthReport.jasper";
//	private final String fileName = "/reports/test.jasper";

	private List<TopupReportDateModel> model;

	public TouupMonthReport() {
		super();
	}
	...
	public List<TopupReportDateModel> getModel() {
		return model;
	}

	public void setModel(List<TopupReportDateModel> model) {
		this.model = model;
	}
