...
public class MoneyReportTransactionReport extends AbstractReport {
	...
	private final String fileName = "/reports/MoneyTransactionReport.jasper";

	private List<MoneyReportModel> model;

	public MoneyReportTransactionReport() {
		super();
	}
