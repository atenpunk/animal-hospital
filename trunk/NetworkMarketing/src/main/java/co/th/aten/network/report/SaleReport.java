...
public class SaleReport extends AbstractReport {
	...
	private final String fileName = "/reports/taxInvoiceAndReceipt.jasper";
//	private final String fileName = "/reports/test.jasper";

	private List<SalePDFModel> model;
	...
	public List<SalePDFModel> getModel() {
		return model;
	}

	public void setModel(List<SalePDFModel> model) {
		this.model = model;
	}
