...
import co.th.aten.football.ui.form.DetailPlayerPanel;
 ...
 * @author mai
 */
public class DetailPlayerDialog extends ApplicationDialog {

    private DetailPlayerPanel panel;

    public DetailPlayerDialog() {
...
//        bpanel.add(btClose);
    ...
    protected JComponent createDialogContentPane() {
        ...
        height = height - (int) (height * 0.09);
        width = width - (int) (width * 0.09);
        System.out.println("--->>>>" + height + ", " + width);
        Dimension dimension = new Dimension(width, height);
        if (panel == null) {
            panel = new DetailPlayerPanel();
        }
