 ...
 * @author Atenpunk
 */
public class PlayersDetailReportDialog_02 extends ApplicationDialog {

//    private PosStockModel filter;
    private List<PlayersModel> playersModelList;

    public PlayersDetailReportDialog_02(List<PlayersModel> playersModelList) {
//        this.filter = filter;
    ...
    protected JComponent createDialogContentPane() {
        ...
        setResizable(true);
        PlayersDetailReport_02 print = new PlayersDetailReport_02(playersModelList);
