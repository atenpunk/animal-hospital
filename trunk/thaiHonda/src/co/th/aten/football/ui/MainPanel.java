...
//        System.out.println("User Class=" + uClass);
    ...
    private void initComponents() {
        ...
        btComparePlayers = new javax.swing.JButton();
        ...
        btComparePlayers.setBackground(new java.awt.Color(255, 247, 102));
        btComparePlayers.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        btComparePlayers.setMnemonic('p');
        btComparePlayers.setText(bundle.getString("main.label.ComparePlayers")); // NOI18N
        btComparePlayers.setPreferredSize(new java.awt.Dimension(200, 80));
        btComparePlayers.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btComparePlayersActionPerformed(evt);
            }
        });
        jPanel6.add(btComparePlayers, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 370, -1));
...
//        AddStaffWizard.getInstance().execute();
    ...
    private void btComparePlayersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btComparePlayersActionPerformed
        new ComparePlayersDialog().showDialog();
    }//GEN-LAST:event_btComparePlayersActionPerformed
