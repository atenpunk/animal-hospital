 ...
 * @author Atenpunk
 */
public class PlayersDetailReport_02 extends AbstractReport {

    private JRViewer jrViewer;
    private String fileName = "reports/ReportTable_02.jasper";
    private List<PlayersModel> modelList;

    public PlayersDetailReport_02(List<PlayersModel> modelList) {
