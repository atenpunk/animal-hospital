...
public class MoneyReportTransferReport extends AbstractReport {
	...
	private final String fileName = "/reports/MoneyTransferReport.jasper";

	private List<MoneyReportModel> model;

	public MoneyReportTransferReport() {
		super();
	}
