...
import co.th.aten.hospital.ui.form.SearchOwnerPanel;
 ...
 * @author mai
 */
public class SearchOwnerDialog extends ApplicationDialog {

    private SearchOwnerPanel panel;

    public SearchOwnerDialog() {
