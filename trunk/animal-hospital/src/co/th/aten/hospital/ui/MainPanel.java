...
//        System.out.println("User Class=" + uClass);
    ...
    private void initComponents() {
        ...
        btEdit.setText(bundle.getString("main.label.editCustomer")); // NOI18N
        ...
        btChangeOwner.setText(bundle.getString("main.label.changeOwner")); // NOI18N
        ...
        btCancelStatement.setBackground(new java.awt.Color(32, 249, 226));
        btCancelStatement.setFont(new java.awt.Font("Dialog", 1, 18));
        btCancelStatement.setMnemonic('p');
        btCancelStatement.setText(bundle.getString("main.label.cancelStmt")); // NOI18N
        btCancelStatement.setPreferredSize(new java.awt.Dimension(200, 80));
        btCancelStatement.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btCancelStatementActionPerformed(evt);
            }
        });
        ...
        btSellTag.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btSellTagActionPerformed(evt);
            }
        });
        ...
        btCheckBalance.setText(bundle.getString("main.label.checkBalance")); // NOI18N
        ...
        btTopup.setText(bundle.getString("main.label.refill")); // NOI18N
        ...
        btCloseContract.setBackground(new java.awt.Color(255, 153, 0));
        btCloseContract.setFont(new java.awt.Font("Dialog", 1, 18));
        btCloseContract.setMnemonic('a');
        btCloseContract.setText(bundle.getString("main.label.return")); // NOI18N
        btCloseContract.setPreferredSize(new java.awt.Dimension(200, 80));
        btCloseContract.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btCloseContractActionPerformed(evt);
            }
        });
        jPanel6.add(btCloseContract, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 30, 370, -1));

        btClaim.setBackground(new java.awt.Color(255, 204, 153));
        btClaim.setFont(new java.awt.Font("Dialog", 1, 18));
        btClaim.setMnemonic('y');
        btClaim.setText(bundle.getString("main.label.claim")); // NOI18N
        btClaim.setPreferredSize(new java.awt.Dimension(200, 80));
        ...
        btSellStatement.setText(bundle.getString("main.label.sellStmt")); // NOI18N
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("main.label.stock"))); // NOI18N
        jPanel7.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        btReceive.setBackground(new java.awt.Color(204, 204, 255));
        btReceive.setFont(new java.awt.Font("Dialog", 1, 18));
        btReceive.setMnemonic('h');
        btReceive.setText(bundle.getString("main.label.receiveOBU")); // NOI18N
        btReceive.setPreferredSize(new java.awt.Dimension(200, 80));
        btReceive.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btReceiveActionPerformed(evt);
            }
        });
        jPanel7.add(btReceive, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 370, -1));

        btSend.setBackground(new java.awt.Color(102, 102, 255));
        btSend.setFont(new java.awt.Font("Dialog", 1, 18));
        btSend.setText(bundle.getString("main.label.returnOBU")); // NOI18N
        btSend.setPreferredSize(new java.awt.Dimension(200, 80));
        btSend.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btSendActionPerformed(evt);
            }
        });
        jPanel7.add(btSend, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 30, 370, -1));
...
//        new ObuReturnDialog().showDialog();
    ...
    private void btCloseContractActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCloseContractActionPerformed
...
//        ClaimWizard.getInstance().execute();
    ...
    private void btSellTagActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSellTagActionPerformed
...
//        CheckBalanceWizard.getInstance().execute();
    ...
    private void btCancelStatementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelStatementActionPerformed
...
//        SellStatementWizard.getInstance().execute();
    ...
    private javax.swing.JButton btCloseContract;
